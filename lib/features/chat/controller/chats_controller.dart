...
import 'package:prettyrini/features/chat/service/chat_service.dart';
...
class ChatController extends GetxController {
  ...
  void fetchChats(String receiverId) {
    ...
    _socketService.sendMessage("fetchChatsAdmin", {"receiverId": receiverId});
  }
  ...
  void sendMessage(String receiverId, String message, {List<String>? images}) {
    ...
    _socketService.sendMessage("messageAdmin", payload);
  }
